...
*/
  ...
  console.log(
    text.replace(/Manuel Marques de Sousa/, "Leandro Andrade de Almeida")
  );
...
*/
  ...
  console.log(
    text.replace(/(O Centauro de Luvas)/, function(word) {
...
*/
  ...
  var getMonthNumber = function(month) {
    ...
    numberMonth = months.indexOf(month);
    formatedNumber = numberMonth.toString().match(/(\d\d)/)
      ? "" + numberMonth
      : "" + 0 + numberMonth;
    return formatedNumber;
  };

  var showMonthPhrase = function(month) {
    return console.log(
      "O mês de " +
        month +
  ...
  showMonthPhrase("março");
  showMonthPhrase("setembro");
  showMonthPhrase("dezembro");
  /*
...
*/
  ...
  console.log("/(dd) de (junho|julho) de (dddd)/g");
  /*
...
*/
  console.log("\nReplace de datas:");
  // meu
  var replaceDate = function(text) {
    var formatedText = text.replace(regexDate, function(
      fullDate,
      day,
      month,
      year
  ...
  // curso
  function replaceDate2(fullDate, day, month, year) {
    return day + "/" + getMonthNumber(month) + "/" + year;
  }
  console.log(text.replace(regexDate, replaceDate2));
})();
