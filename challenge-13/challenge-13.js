...
*/
  ...
  var arr = [1, 2, 3, "true", false, { prop1: 1 }, function() {}];
...
*/
  ...
  brasil.unshift("Minas Gerais", "Goias");
  console.log(brasil);
  /*
...
chamada `newSudeste`.
*/
  var newSudeste = brasil.splice(4, 4);
...
*/
  ...
  var has7 = brasil.every(function(item) {
    return item.length > 7;
  });

  var answer = (function(has7) {
    if (has7) 
...
*/
  ...
  // de outro jeito:
  var newerBrasil2 = newBrasil.map(
    function(item, index) {
      item.id = index+1   
...
*/
  ...
  newerBrasil.forEach( function(item) {
    console.log(item);
  });
...
*/
  var filter = newerBrasil.filter(function(item) {
    return item.id % 2 === 0;
  })
