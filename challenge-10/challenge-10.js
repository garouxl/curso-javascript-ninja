...
*/
  ...
  // melhorando a calc
  function execCalculator(number1, number2, operationSignal) {
  ...
  execCalculator(50, 20, "-");
  execCalculator(10, 20, "*");
  execCalculator(1000, 20, "/");
  execCalculator(50, 5, "%");
...
*/
  ...
  var outro = calculator(operationSignal);
